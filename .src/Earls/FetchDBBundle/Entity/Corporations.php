...
class Corporations
{
    ...
    /**
     * @var \Earls\FetchDBBundle\Entity\Registeredoffices
     *
     * @ORM\ManyToOne(targetEntity="Earls\FetchDBBundle\Entity\Registeredoffices")
     * @ORM\JoinColumns({
    ...
    /**
     * @var \Earls\FetchDBBundle\Entity\Recordsoffices
     *
     * @ORM\ManyToOne(targetEntity="Earls\FetchDBBundle\Entity\Recordsoffices")
     * @ORM\JoinColumns({
